...
import CJIcon from '../assets/icon.png';
    ...
    <div className='channel-list__sidebar'>
        <div className='channel-list__sidebar__icon1'>
            <div className='icon1__inner'>
                <img src={CJIcon} alt="Coding-junction" width="30" />
            </div>
        </div>
...
const CompanyHeader = () => (
    <div className='channel-list__header'>
        <p className='channel-list__header__text'>Mother of Dragons</p>
    </div>
)
...
const ChannelListContent = ({ isCreating, setIsCreating, setCreateType, isEditing, setIsEditing, setToggleContainer }) => {
